...
def forecast_city(events: list, city: dict, explain: bool = False) -> dict:
    ...
    return {
        ...
        "pilot_probability": float(pred.get("pilot_probability", 0.0)),
        "pilot_available": bool(pred.get("pilot_available", False)),
        "pilot_province": pred.get("pilot_province"),
        "pilot_region_distance_km": _optional_float(pred.get("pilot_region_distance_km")),
        "pilot_weekly_count_prediction": float(pred.get("pilot_weekly_count_prediction", 0.0)),
        "pilot_signal_weight": float(pred.get("pilot_signal_weight", 0.0)),
